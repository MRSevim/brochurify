...
const SpeechBubble = ({ text }: { text: string }) => {
  return (
    <div
      ...
      z-50
      before:absolute before:content-[''] before:w-0 before:h-0 before:border-8 before:border-transparent 
      before:border-b-zinc-800 before:right-0 before:bottom-full"
    >
      <SmallText text={text} />
    </div>
  );
